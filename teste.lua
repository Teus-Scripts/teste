...
do
	local sasasa = game:GetService("CoreGui"):FindFirstChild("sasasa")
	if sasasa then sasasa:Destroy() end
end

local sasasa = Instance.new("ScreenGui")
...
sasasa.Name = "sasasa"
sasasa.Parent = game:GetService("CoreGui")

Prefabs.Name = "Prefabs"
Prefabs.Parent = sasasa
...
do -- Example UI
	local Window = library:AddWindow("Zeus", {
		main_color = Color3.fromRGB(139, 0, 0),
		min_size = Vector2.new(300, 195),
		toggle_key = Enum.KeyCode.RightShift,
		can_resize = true,
	})
	local Tab = Window:AddTab("Blox Fruits")

	do -- Elements
		Tab:AddLabel("Thanks For Using Zeus")

		Tab:AddButton("MheeHub GUI", function()
			loadstring(game:HttpGet("https://raw.githubusercontent.com/BunnySalf/Hentai/main/MHEEHUB",true))()
		end)
		Tab:AddButton("Bigger GUI", function()
			loadstring(game:HttpGet("https://raw.githubusercontent.com/noob1ee1/blox-fruits-script/main/bloxfruits"))()
		end)
		Tab:AddButton("WalterHub GUI", function()
			loadstring(game:HttpGet("https://raw.githubusercontent.com/WalterCums/hub/main/Detection.lua", true))()
		end)
		Tab:AddButton("Old GUI", function()
			loadstring(game:HttpGet("https://pastebin.com/raw/VP3xvFH3"))()
		end)
